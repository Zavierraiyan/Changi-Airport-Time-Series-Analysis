...
\large
{\bf Disusun oleh: \\Kelompok X}

\begin{table}[ht]
  \centering
  \begin{tabular}{ll}
  
  \large{\bf Anggota 1} & \large{\bf 2200000000} \\
  \large{\bf Anggota 2} & \large{\bf 2200000000} \\
  \large{\bf Anggota 3} & \large{\bf 2200000000} \\ 
  \large{\bf Anggota 4} & \large{\bf 2200000000}  \\ 
  \large{\bf Anggota 5} & \large{\bf 2200000000} \\ 
...
\large
{\bf PROGRAM STUDI STATISTIKA\\FAKULTAS MATEMATIKA DAN ILMU PENGETAHUAN ALAM\\UNIVERSITAS INDONESIA\\MEI 2024}
...
\begin{table}[ht]
  ...
  1.  & Anggota 1 & 2200000000 & Mengerjakan \emph{project} & 100\% \\ 
  
  2.  & Anggota 2 & 2200000000 & Mengerjakan \emph{project} & 100\% \\ 

  3.  & Anggota 3 & 2200000000 & Mengerjakan \emph{project} & 100\% \\ 
  
  4.  & Anggota 4 & 2200000000 & Mengerjakan \emph{project} & 100\% \\ 
  
  5.  & Anggota 5 & 2200000000 & Mengerjakan \emph{project} & 100\% \\ 
